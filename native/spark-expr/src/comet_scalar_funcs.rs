...
fn all_scalar_functions() -> Vec<Arc<ScalarUDF>> {
    vec![
        ...
        Arc::new(ScalarUDF::new_from_impl(crate::math_funcs::math_expr::SecFunc)),
        Arc::new(ScalarUDF::new_from_impl(crate::math_funcs::math_expr::CscFunc)),
        Arc::new(ScalarUDF::new_from_impl(crate::math_funcs::math_expr::CbrtFunc)),
        Arc::new(ScalarUDF::new_from_impl(crate::math_funcs::math_expr::HypotFunc)),
