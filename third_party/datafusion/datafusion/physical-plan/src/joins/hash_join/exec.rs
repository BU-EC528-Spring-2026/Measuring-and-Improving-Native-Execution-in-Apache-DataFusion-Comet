...
pub(super) struct JoinLeftData {
    ...
    ///Pranav's code
    pub(super) build_has_null_key: bool,
}
...
impl fmt::Debug for HashJoinExec {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("HashJoinExec")
            ...
            // Pranav's code
            .field("is_null_aware_anti_join", &self.is_null_aware_anti_join)
...
async fn collect_left_input(
    ...
    let build_has_null_key = left_values.iter().any(|arr| arr.null_count() > 0);
